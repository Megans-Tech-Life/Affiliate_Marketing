import uuid
from sqlalchemy import Column, String, DateTime, ForeignKey, Table, Integer, Text, JSON
...
class Lead(Base):
    ...
    # Many-to-many relationship with accounts (leads serve as contacts for accounts)
    accounts = relationship("Account", secondary=lead_accounts, back_populates="contacts")
